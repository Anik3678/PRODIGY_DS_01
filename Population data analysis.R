...
#Load the data
population<-read.csv("C:\\Users\\User\\Documents\\Data science\\Prodigy Infotech Internship\\Task-1\\world_population.csv")
...
#Dataset for last 10 countries in the year of 2020
...
#Bar diagram for last 10 countries in the year of 2020
